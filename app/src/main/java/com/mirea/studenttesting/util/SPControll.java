package com.mirea.studenttesting.util;
...
public class SPControll {
    ...
    private static final SPControll SPControl = new SPControll();

    public static SPControll getInstance() {
        return SPControl;
    }
